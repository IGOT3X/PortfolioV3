    ...
    return(
        ...
        <div className="relative">
            ...
            <div className="sm:absolute flex gap-[8px] sm:top-[-16px] sm:right-[-80px] justify-center">
                ...
                <a onMouseOver={()=>setToolTip("Download CV")} onMouseLeave={ResetToolTip} href="resume.pdf" download={true} className="transition ease-in-out duration-300 hover:scale-105"><img src="cv.svg" alt="" /></a>
            </div>
        </div>
    </div>
    )
