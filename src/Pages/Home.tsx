...
const Home = () => {
    ...
    useEffect(()=>{
        ...
        // Stupid issues require stupid solutions ^^
    },[]);

    return (
        <div className="w-screen sm:h-screen sm:flex text-black-100 overflow-visible">
            ...
            <div className="flex flex-col sm:hidden transition ease-in-out duration-700 items-center gap-[75px] pt-[64px]">
                ...
                <a  href="projects" className="flex flex-col gap-[8px]">
