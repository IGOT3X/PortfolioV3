...
const Home = () => {
    return (
        <div className="w-screen sm:h-screen bg-black-900 sm:flex text-black-100">
            ...
            <div className="sm:ml-[123px] pt-[64px] sm:pt-0 w-full h-full flex flex-col items-start justify-center sm:max-w-[513px] z-40">
                <Profile />
                <h1 className="font-semibold sm:text-[96px] text-[64px]">Full-Stack <br /> developer;</h1>
                <p className="text-green-300 font-semibold sm:text-[24px] pt-[8px]">Proficient in crafting dynamic and user-centric web applications.</p>
                <div className="w-[130px] h-[60px] mt-[17px]">
                ...
                <div className="flex flex-col items-center mx-auto gap-[17px]">
            ...
            <div className="md:flex hidden flex-col transition ease-in-out duration-700 2xl:rotate-[-32deg] xl:rotate-[-24deg] sm:rotate-[0deg] items-center gap-[75px]">
